...
fetchJson().then((getPlanets) => {
  ...
  const planetMercury = [
    ...
    mercuryTemp,
    mercuryOverviewText,
    mercuryOverviewSourceLink,
    mercuryOverviewImg,
    mercuryInternalText,
    mercuryInternalSourceLink,
    mercuryInternalImg,
    mercuryGeologyText,
    mercuryGeologySourceLink,
    mercuryGeologyImg,
    mercuryColor,
  ];
  ...
  const planetVenus = [
    ...
    venusTemp,
    venusOverviewText,
    venusOverviewSourceLink,
    venusOverviewImg,
    venusInternalText,
    venusInternalSourceLink,
    venusInternalImg,
    venusGeologyText,
    venusGeologySourceLink,
    venusGeologyImg,
    venusColor,
  ];
  ...
  const planetEarth = [
    ...
    earthTemp,
    earthOverviewText,
    earthOverviewSourceLink,
    earthOverviewImg,
    earthInternalText,
    earthInternalSourceLink,
    earthInternalImg,
    earthGeologyText,
    earthGeologySourceLink,
    earthGeologyImg,
    earthColor,
  ];
  ...
  const planetMars = [
    ...
    marsTemp,
    marsOverviewText,
    marsOverviewSourceLink,
    marsOverviewImg,
    marsInternalText,
    marsInternalSourceLink,
    marsInternalImg,
    marsGeologyText,
    marsGeologySourceLink,
    marsGeologyImg,
    marsColor,
  ];
  ...
  const planetJupiter = [
    ...
    jupiterTemp,
    jupiterOverviewText,
    jupiterOverviewSourceLink,
    jupiterOverviewImg,
    jupiterInternalText,
    jupiterInternalSourceLink,
    jupiterInternalImg,
    jupiterGeologyText,
    jupiterGeologySourceLink,
    jupiterGeologyImg,
    jupiterColor,
  ];
  ...
  const planetSaturn = [
    ...
    saturnTemp,
    saturnOverviewText,
    saturnOverviewSourceLink,
    saturnOverviewImg,
    saturnInternalText,
    saturnInternalSourceLink,
    saturnInternalImg,
    saturnGeologyText,
    saturnGeologySourceLink,
    saturnGeologyImg,
    saturnColor,
  ];
  ...
  const planetUranus = [
    ...
    uranusTemp,
    uranusOverviewText,
    uranusOverviewSourceLink,
    uranusOverviewImg,
    uranusInternalText,
    uranusInternalSourceLink,
    uranusInternalImg,
    uranusGeologyText,
    uranusGeologySourceLink,
    uranusGeologyImg,
    uranusColor,
  ];
  ...
  const planetNeptune = [
    ...
    neptuneTemp,
    neptuneOverviewText,
    neptuneOverviewSourceLink,
    neptuneOverviewImg,
    neptuneInternalText,
    neptuneInternalSourceLink,
    neptuneInternalImg,
    neptuneGeologyText,
    neptuneGeologySourceLink,
    neptuneGeologyImg,
    neptuneColor,
  ];
//   selector
  ...
  const planetGeologyImg = document.querySelector('#planetGeologyImg');
  const planetText = document.querySelector('#planetText');
  const sourceLink = document.querySelector('#sourceLink');
  const rotationText = document.querySelector('#rotationText');
  const revolutionText = document.querySelector('#revolutionText');
  ...
  internalButtonMobile.addEventListener("click", () =>
    internalStructureChange()
  );
  ...
  //function for changing planet when nav bar clicked
...
function toggleMenu() {
  if (menu.classList.contains("showMenu")) {
    ...
    htmlTag.classList.remove('prevent')
  } else {
    menu.classList.add("showMenu");
    closeIcon.style.display = "";
    menuIcon.style.display = "none";
    main.classList.add("hide");
    htmlTag.classList.add('prevent')
  }
}
...
let finalClamp = `clamp(${minFontSize}rem, ${yAxisIntersection.toFixed(
  4
)}rem + ${clampSlope.toFixed(4)}vw, ${maxFontSize}rem);`;
